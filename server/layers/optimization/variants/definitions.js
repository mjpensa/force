...
RULES:
1. TIME: If user specifies a range (e.g., 2025-2030), use EXACTLY that range for timeColumns. Include ALL tasks - only exclude those with EXPLICIT dates outside the range.
