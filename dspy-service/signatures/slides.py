...
class SlidesSignature(dspy.Signature):
    ...
    **AVOID these letters in title words: g, y, p, q, j**
    ...
    TITLE FORMAT: Each title MUST be EXACTLY 4 lines. Each line MUST NOT EXCEED 10 characters. Total across all lines MUST NOT EXCEED 40 characters. Use \n to separate lines.
    """
    ...
    slides: List[dict] = dspy.OutputField(
        desc="Array of slide objects. Each slide must have 'tagline' (uppercase, EXACTLY 2 words, max 21 chars total), 'title' (main headline - AVOID letters g,y,p,q,j except on last line), 'body' (EXACTLY 2 paragraphs, each 4-6 lines, separated by double newline)"
    )
